...
pairs_penalties="0.0 1.0 0.01 0.0001 10.0"
roots_penalties="0.0 1.0 0.01 0.0001 10.0"
svd_penalties="0.0 1.0 0.01 0.0001 10.0"
                                                ...
                                                for roots_penalty in ${roots_penalties[@]}; do
                                                    for svd_penalty in ${svd_penalties[@]}; do
                                                        for rep in `seq $reps`; do
                                                            ...
                                                            commands+=("srun --gres=gpu:1 --partition=titanx-long,m40-long --time=08:00:00 python network.py \
